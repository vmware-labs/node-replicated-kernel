...
OVMF_DIR = WORKSPACE_DIR / 'bootloader'
...
def build():
    ...
    run_xargo('build', '--package', 'bootloader')

    # Copy the built file to the right directory for running tests.
    built_file = BUILD_DIR / 'bootloader.efi'
...
def main():
    ...
    os.environ['RUST_TARGET_PATH'] = str(WORKSPACE_DIR / 'bootloader')
