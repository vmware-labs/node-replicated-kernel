...
#[cfg(all(feature = "integration-test", target_arch = "x86_64"))]
fn dcm() {
    use crate::arch::rackscale::dcm::allocate_physical::rpc_allocate_physical;
    use crate::arch::rackscale::dcm::request_core::rpc_request_core;
    ...
    for _ in 0..5 {
        ...
        let _mem_ret = rpc_allocate_physical(&mut **client, pid, page_size, affinity).unwrap();
